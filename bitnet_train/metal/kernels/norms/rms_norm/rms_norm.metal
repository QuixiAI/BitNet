...
// Dynamic-D RMSNorm for widths whose full row would blow registers (2048/3072/...):
// two strided passes over the row (sum-of-squares, then normalize) instead of keeping
// the row resident — the quantize_per_token pattern. One simdgroup per row; any D%4==0.
